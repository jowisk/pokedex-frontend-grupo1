...
const DetailHeader = (props) => {
    ...
    const nextPokemon = parseInt(props.selectedPokemon.id) + 1;
    const previousPokemon = parseInt(props.selectedPokemon.id) - 1;
  return (
    <>
     <img src={props.selectedPokemon.image} className="absolute top-[13%] z-[100] m-auto left-0 right-0 w-[250px] h-[250px]"/>
     ...
     <div className={` w-full h-[33%] p-[20px] flex flex-col justify-between`}>
            <div className=" flex justify-between">
                <div className="flex items-center">
                    ...
                    <p className={`font-semibold text-[25px] capitalize text-white`}>{props.selectedPokemon.name}</p>
                </div>

                <div className="flex items-center">
                    <p className="text-[25px] font-semibold text-white">#{String(props.selectedPokemon.id).padStart(3,'0')}</p>
                </div>
            </div>
